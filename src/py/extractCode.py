...
def extractCommandData(DIR,extract="python",exclude_list=[],long_space=15,short_space=5):
    ...
    with open(output_json,'w',encoding="utf-8") as f:
        json.dump({"completions": command_info}, f, indent=4)
...
if __name__ == "__main__":
    ...
    # FILE = Path(__file__)
    # DIR = FILE.parent / "maya-2019.2-user-guide_enu_offline" / "Commands"
    # DIR = FILE.parent / "maya-2019.2-user-guide_enu_offline" / "CommandsPython"
    DIR = r"D:\Users\Administrator\Desktop\MayaDoc\maya-2019.2-user-guide_enu_offline\CommandsPython"
    extractCommandData(DIR, "python", exclude_list=exclude_list + obselete_list)
